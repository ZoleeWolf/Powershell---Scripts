...
Write-Host "=========================="
Write-Host "=== Enabling SW Updates =="
Write-Host "=========================="
...
# Enable each deployment
$deployments = $deployments | Where-Object { $_.Enabled -eq $False }
$deployments | select AssignmentName,Enabled | sort Enabled,AssignmentName
$deployments | Set-CMSoftwareUpdateDeployment -Enable $True
...
Write-Output "All Software Update Deployments have been Enabled."
